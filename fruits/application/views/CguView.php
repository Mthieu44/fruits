					...
					<a href="<?= site_url('Connexion') ?>">
						<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="30.000000pt" height="30.000000pt"
							...
							<g transform="translate(0.000000,400.000000) scale(0.100000,-0.100000)" fill="#000000"
								stroke="none">
								<path
									d="M1935 3315 c-321 -61 -566 -296 -640 -615 -22 -96 -20 -269 5 -366 68 -267 267 -484 519 -567 215 -72 411 -57 620 44 91 44 116 63 196 142 158 158 233 321 242 533 12 244 -70 450 -248 620 -187 179 -444 256 -694 209z" />
								<path
									d="M1363 1750 c-386 -239 -625 -634 -659 -1087 l-7 -93 1381 0 1380 0 -4 78 c-12 182 -65 384 -141 537 -114 228 -333 462 -544 579 l-45 26 -60 -46 c-78 -59 -239 -138 -339 -166 -116 -32 -374 -32 -490 0 -106 29 -242 95 -333 160 -40 28 -74 52 -75 51 -1 0 -30 -18 -64 -39z" />
							</g>
						</svg>
						<?php
	...
	<body>
		<div class="texte">
			...
			<p class="cgu">
				...
				Les présentes CGU ont pour objet de définir les modalités et conditions dans lesquelles d'une part,
				Fruits,
				ci-après dénommé l'« Éditeur », met à la disposition de ses utilisateurs le site http://172.26.82.54/,
				et
				les services disponibles sur le site et d'autre part, la manière par laquelle l'utilisateur accède au
				site
			...
			<p class="cgu">
				...
				l'utilisation du site, l'utilisateur accepte de se soumettre à ces CGU. Si l'utilisateur n'accepte pas
				ces
			...
			<p class="cgu">
				...
				L'éditeur du site http://172.26.82.54/ est Fruits, une société Anonyme, immatriculée au 451 432 228 et
				ayant
			...
			<p class="cgu">
				...
				Le site http://172.26.82.54/ est accessible gratuitement à tout utilisateur disposant d'un accès à
				Internet.
			...
			<p class="cgu">
				...
				Toutefois, Fruits ne pourra être tenu responsable des omissions, des inexactitudes et des carences dans
				la
				...
				susceptibles d'évoluer. Par ailleurs, les renseignements figurant sur le site ne sont pas exhaustifs.
				Ils
			...
			<p class="cgu">
				...
				Fruits est propriétaire des droits de propriété intellectuelle ou détient les droits d'usage sur tous
				les
			...
			<p class="cgu">
				...
				Le site http://172.26.82.54/ peut contenir des liens hypertextes vers d'autres sites présents sur le
				réseau
			...
			<p class="cgu">
				...
				Fruits ne pourra être responsable d'aucun dommage direct ou indirect, quelle qu'en soit la cause,
				origine,
				nature ou conséquence, découlant de l'accès au site ou de l'impossibilité d'y accéder, de l'utilisation
				du
			...
			<p class="cgu">
				...
				Tout litige en relation avec l'utilisation du site http://172.26.82.54/ est soumis au droit français. Il
				est
			...
			<p class="cgu">
				...
				Lors de la consultation du site http://172.26.82.54/, des cookies peuvent être installés sur
				l'ordinateur de
				l'utilisateur. Un cookie est un fichier de petite taille, qui ne permet pas l'identification de
				l'utilisateur, mais qui enregistre des informations relatives à la navigation d'un ordinateur sur un
				site.
