...
<head>
    ...
    <style>
        <?php include 'css/style.css'; ?><?php include 'css/commande.css'; ?>
    </style>
...
<body>
            ...
            <ul>
                ...
                <li class="panier">
                    <a href="<?= site_url('Panier') ?>">
                        <svg version="1.0" class="yellow" xmlns="http://www.w3.org/2000/svg" width="40.000000pt" height="40.000000pt" viewBox="0 0 400.000000 400.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,400.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
    ...
    <div class="content">
        <h2> Voici votre commande <?= $this->session->user["user"]->getPrenom()?> </h2>
