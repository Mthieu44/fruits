				...
				<div class="uppercontent">
					<div class="content">
						...
						<div class="form">
							<div class="row">
								<div class="col">
									...
									<input id="prenom" type="text" name="prenom" placeholder="Votre prénom"
										value="<?= $this->session->user["user"]->prenom ?>" required>
								</div>
								<div class="col">
							...
							<input type="text" id="telephone" name="objet" placeholder="Telephone" minlength="10"
								maxlength="10" value="<?= $this->session->user["user"]->telephone ?>">
						</div>
						<div class="buttons">
							<button type="button" class="prev-btn"
								onclick="window.location='<?= site_url('Panier') ?>';">Précédent</button>
						...
						<div class="toutPanier">
							<table>
								...
								<tr v-for="fruit in panier" v-bind:key="fruit.id_fruit" class="fruitDansPanier">
									...
									<td>{{getTotalProduit(fruit.id_fruit)}} <?= $GLOBALS['calculator']->getCurrency() ?>
									</td>
