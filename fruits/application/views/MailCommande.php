					...
					<div class="u-row-container" style="padding: 0px;background-color: transparent">
						<div class="u-row"
							...
							<div
								...
								<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #f6eaca;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
								<div class="u-col u-col-100"
									style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
									<div style="background-color: #f6eaca;height: 100%;width: 100% !important;">
										<!--[if (!mso)&(!IE)]><!-->
										<div
																...
																<tr>
																	<td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
																		...
																		<img align="center" border="0"
																			src="https://cdn.discordapp.com/attachments/1029021864292520056/1062028885644038224/logo.png"
																			alt="image" title="image"
																			style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 45%;max-width: 261px;"
																			width="261" class="v-src-width v-src-max-width" />
											...
											<table id="u_content_heading_2" style="font-family:'Open Sans',sans-serif;" role="presentation"
												...
												<tbody>
													<tr>
														<td class="v-container-padding-padding"
															style="overflow-wrap:break-word;word-break:break-word;padding:20px 15px 40px;font-family:'Open Sans',sans-serif;"
															align="left">

															<h1 class="v-text-align v-font-size"
																style="margin: 0px; color: #000000; line-height: 120%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 25px;">
																<strong> <?= $title ?> <?php if (isset($name)): ?> <?= $name ?> <?php endif ?>
																	!</strong></h1>
												...
												<tbody>
													<tr>
														<td class="v-container-padding-padding"
															...
															<h1 class="v-text-align v-font-size"
																style="margin: 0px; color: #ffbb00; line-height: 120%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 24px;">
																<strong><?= $subtitle ?> <?php if (isset($date)): ?> <?= $date ?>
																	<?php endif ?></strong></h1>
													...
													<tr>
														<td class="v-container-padding-padding"
															...
															<div class="v-text-align" align="center">
																<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:37px; v-text-anchor:middle; width:174px;" arcsize="67.5%"  stroke="f" fillcolor="#ffbb00"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Open Sans',sans-serif;"><![endif]-->
																<a href="http://172.26.82.54/index.php/Connexion" target="_blank"
																	class="v-button v-size-width v-border-radius"
																	style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ffbb00; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
																	<span style="display:block;padding:10px 20px;line-height:120%;"><strong><span
																				style="font-size: 14px; line-height: 16.8px;">Se
																				connecter</span></strong></span>
																</a>
													...
													<tr>
														<td class="v-container-padding-padding"
															...
															<div class="v-text-align"
																...
																<p style="font-size: 14px; line-height: 160%;">N'hésitez pas à nous faire des retours !
																</p>
																<p style="font-size: 14px; line-height: 160%;">Merci !</p>
																<p style="font-size: 14px; line-height: 160%;">Fruits, Nantes.</p>
															</div>
