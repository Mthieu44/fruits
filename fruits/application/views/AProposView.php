...
<body>
		...
		<header>
			...
			<nav>
				...
				<ul>
					...
					<li><a href="<?= site_url('APropos') ?>" class="propos yellow">A propos</a></li>
    ...
    ?>
		...
		<div class="content">
			...
			<p class="p01">Nous sommes des passionés de fruits, et nous souhaitons partager au plus grand nombre cette
				passion qui nous tient tant à cœur. Nous faisons appel aux producteurs locaux pour vous proposer les
				fruits
				de la plus grande qualité possible.</p>
			<img src="<?= base_url('img/tierlist.png') ?>" alt="tierlist">
			<p class="p01">Site réalisé par Mathieu BERGERON, Tom FRERET, Fabien NICOU, Sylvain BAUDOUIN, Tomas
				MARTINEAU
				dans le cadre de la SAE "Développement d'une application" à l'IUT de Nantes. </p>
		</div>
