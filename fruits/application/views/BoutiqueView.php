...
<body>
  <div id = "app-vue">
    ...
    <div id="panierVolet">
      <div id="voletFleche" onclick="flechePanier()">
        ...
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="40.000000pt" height="40.000000pt" viewBox="0 0 400.000000 400.000000" preserveAspectRatio="xMidYMid meet">
          <g transform="translate(0.000000,400.000000) scale(0.100000,-0.100000)" fill="#7dd181" stroke="none">
        ...
        <img src="<?= base_url('img/back.png') ?>" class="fleche" alt="back" />
          <div v-for= "fruit in fruits" v-bind:key="fruit.id_fruit"class="card-product">
            ...
            <div class="add-to-cart">
              ...
              <button class="addPanier" onclick="addPanier(<?= 1 ?>)">Ajouter au panier</button>
              <script  type="application/javascript" src="<?= base_url('js/notiflix-Notiflix-dfaf93f/dist/notiflix-aio-3.2.5.min.js') ?>"></script>
              <!--<script type="application/javascript" >
                var totalQuantity = document.getElementById("totalQuantity".concat(<?= 1 ?>));
    ...
    <div class="productsMenu blur">
      <div v-for= "fruit in fruits" v-bind:key="fruit.id_fruit" class="card-product blur">
        <a href="<?= site_url('Produit') ?>">
