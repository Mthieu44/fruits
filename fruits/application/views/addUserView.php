...
<body>
    ...
    <form action="<?= site_url('User/addUser') ?>" method="post" class="register">
        ...
        <input type="password" name="password2" id="pass2" placeholder=" Confirmer mot de passe" maxlength="20"
            required>
        <div class="sexe">
            <input type="radio" name="status" value="client" id="client">
            <label for="client">Client</label>
            <input type="radio" name="status" value="responsable" id="responsable">
