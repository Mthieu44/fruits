    ...
    <div id="app-vue">
        ...
        <div class="bestsellers blur">
            ...
            <div class="fruit-menu">
                ...
                <img src="<?= base_url('img/next.png') ?>" class="fleche rightfix" alt="next" onclick="slideBestsellers.slideRight()"/>
        ...
        <div class="bestsellers blur">
            ...
            <div class="fruit-menu">
                ...
                <img src="<?= base_url('img/next.png') ?>" class="fleche rightfix" alt="next" onclick="slideSeasonal.slideRight()"/>
                <div class="slider-hider rightfix"></div>
            </div>
        </div>
