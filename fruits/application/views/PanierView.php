	...
	<div id="app-vue">
		...
		<div class="toutPanier">
			...
			<!--  <table>
				...
				<div v-for="fruit in panier" v-bind:key="fruit.id_fruit">
					<tr>
						<th>Article</th>
						<th>Prix unitaire</th>
						<th>Quantité</th>
					...
					<tr>
						...
						<th> {{ getTotalProduit(fruit.id_fruit)}}</th>
					</tr>
				</div>
