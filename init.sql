...
call addFruit('Prune Quetsche',0.14,"C'est une petite prune qui mûrit dès mi-août, et qui est disponible dans les marchés jusqu'en octobre. Sous sa robe violette, elle cache une chair sucrée, acidulée, d’un jaune d’or légèrement foncé. Sa forme est oblongue et charnue.","France, Alsace","quetsche.png");
...
call addFruit('Mûres',3.00,"La mûre est un fruit rouge comestible de la ronce commune, buisson épineux très enbahissant. Elle est de couleur noir bleuâtre à maturité, à la fin de l'été. Vendues en barquette de 125g environ.","France",".png");
call addFruit('Mangue',3.20,"La mangue est un fruit charnu, pesant de 300 g à 2 kg. Sa chair est jaune foncé, onctueuse, grasse et sucrée avec un faux goût de pêche et de fleur. Vendue à l'unité.","France, Savoie","mure.png");
...
call addFruit('Raisin rouge',0.32,"Le raisin, fruit de la vigne, est un des fruits les plus cultivés au monde. Il se présente sous la forme de grappes composées de nombreux grains. Vendu à la grappe de 120g environ.","France, Pays de la Loire","raisinrouge.png");
...
call addFruit('Citron vert',0.60,"Appelé lime, ce fruit est produit tout au long de l’année au Mexique et aux Caraïbes. D’aspect très proche de celui du citron, il est entièrement vert. Son acidité particulière et parfumée est très prisée. Il mesure entre trois et six centimètres et possède ou non des pépins selon la variété. Vendu à l'unité.","Argentine","citronvert.png");
...
call addFruit("Orange sanguine",0.40,"L'orange sanguine, ou sanguine, est une variété d'orange douce, fruit de l'oranger (Citrus sinensis), dont la couleur de pulpe va du rouge sang au rouge sombre. Une forte amplitude thermique hivernale induit la production d'anthocyanines dans le fruit. Vendue à l'unité.","Sicile","orangesanguine.png");
...
call addFruit("Noix de coco",1.10,"Issue du palmier, la noix de coco n’est pas uniquement d’utilité alimentaire. En grappe de cinq drupes, les noix de coco sont entourées d’une coque fibreuse qu’il faut casser. Sa pulpe interne, juxtaposée à la coque, abrite en son centre un liquide blanc, translucide, sucré et rafraîchissant. Sa chair délicieuse est croustillante. Vendue à l'unité.","Asie du Sud-Est","noixdecoco.png");
